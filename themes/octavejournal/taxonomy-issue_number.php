...
<div class="container">
	...
	<div class="row">
		<div class="issue-single-header large-9  columns">
			<h2 class="issue-single-title">
				<a href="#">Big Bold Issue Title</a>
			</h2>
			<div class="issue-single-meta">
				<h3 class="issue-single-number">
					<a href="#">Issue #1</a>
				</h3>
				<h3 class="issue-single-date">November 2013</h3>
			</div><!-- issue-meta -->
		</div>
	</div><!-- row -->
