...
Install
---
If you don\'t have the package yet, you can download it on GitHub. Unzip it in a ImportUsersX folder, located at the root of your website. Package the extra by running the build.transport.php file in the _build directory. Once you\'ve got the package install it via Package Manager (if you don\'t see it try to select "Search locally for packages" at the top of packages list.
...
',
    'changelog' => 'ImportUsersX
========================

Version 1.0.1-pl : June, 29th 2012

Fix bug that made a refresh required to show the file field.

Version 1.0.0-pl : April, 26th 2012

Add users from a .csv file.
Send an e-mail to each created users and a summary one to the adminstrator from chunks.
Give member or super user role depending on the users group where users are added.',
    'setup-options' => 'importusersx-1.0.1-pl/setup-options.php',
  ),
  'manifest-vehicles' => 
  array (
    0 => 
    array (
      ...
      'class' => 'modNamespace',
      'guid' => '1773841febd9e366e29abfafdc1f32ad',
      'native_key' => 'importusersx',
      'filename' => 'modNamespace/580f7d316cf7cfe8b39d868da303ddeb.vehicle',
    ...
    array (
      ...
      'vehicle_class' => 'xPDOObjectVehicle',
      'class' => 'modCategory',
      'guid' => 'fc3521321301f9e342f1238b5a771c68',
      'native_key' => NULL,
      'filename' => 'modCategory/447c070c805e3adc063df4531eee8f66.vehicle',
      'namespace' => 'importusersx',
    ),
    2 => 
    array (
      ...
      'vehicle_class' => 'xPDOObjectVehicle',
      'class' => 'modMenu',
      'guid' => 'fc93e008a145c665c16a434ce2b8d690',
      'native_key' => 'importusersx',
      'filename' => 'modMenu/676261027947456d509bdc6e0717c81b.vehicle',
      'namespace' => 'importusersx',
    ),
  ),
);