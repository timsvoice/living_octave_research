<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '[[!getResources? &parents=`90` &limit=`1` &depth=`1` &hideContainers=`0` &tpl=`issueTpl` &includeContent=`1` &showHidden=`0` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`featureStory==%yes%` &sortby=`{"createdon":"DESC"}` ]]
...
[[!getResources? &parents=`90` &limit=`1` &depth=`1` &hideContainers=`0` &tpl=`issueTpl` &includeContent=`1` &showHidden=`0` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`featureStory==%yes%` &sortby=`{"createdon":"DESC"}` ]]

<div class="row articles"> 
          <hr>
          <div class="small-12 columns featured-articles">
            <h3 >What we\'re reading</h3>
<p>Articles from our team. Submit an article <a href="mailto:news@livingoctaveresearch.us">here</a>.</p>
          </div>
[[!getResources? 
&parents=`2` 
&limit=`9` 
...
&sortOrder=`DESC`
    ...
    '[[$articleStream]]' => '<div class="row articles"> 
          <hr>
          <div class="small-12 columns featured-articles">
            <h3 >What we\'re reading</h3>
<p>Articles from our team. Submit an article <a href="mailto:news@livingoctaveresearch.us">here</a>.</p>
