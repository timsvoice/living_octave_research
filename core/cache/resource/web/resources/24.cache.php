<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="loginForm">[[!Login? &loginResourceId=`1`]]</div>
[[sessionLog?]]',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 3,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1365531211,
    'editedby' => 1,
    'editedon' => 1370464589,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1365532020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<body 
onload="document.storename.username.value=localStorage.username"
onload="document.storename.password.value=localStorage.password"
>
<div class="container">			
...
<div class="loginForm">[[!Login? &loginResourceId=`1`]]</div>
    ...
    <div class="loginLogin">
        <form class="loginLoginForm" action="[[~[[*id]]]]" method="post">
            <fieldset class="loginLoginFieldset">
                ...
                <input  type="text" class="stored" name="username" value="username"
                 onfocus="if(this.value==this.defaultValue)this.value=\'\'"    
                 onblur="if(this.value==\'\')this.value=this.defaultValue"
                 onchange="handleChange(this);" />
                
                <input  type="password" class="stored" name="password" value="password"
                 onfocus="if(this.value==this.defaultValue)this.value=\'\'"    
                 onblur="if(this.value==\'\')this.value=this.defaultValue"
                 onchange="handleChange(this);" />
...
<label class="loginRemembermeLabel">Remember Me
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'sessionLog',
          'description' => 'keep session looged in for iphone web app',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '// Start or resume session
session_start(); 
...
setcookie(session_name(),session_id(),time()+$cookieLifetime);',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '// Start or resume session
session_start(); 
