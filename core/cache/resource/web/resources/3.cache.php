...
[[!getResources? &parents=`2` &tpl=`postTeaserTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`category==%Learning%` ]]
...
<h1>octave <span id="header_branding_research">research</span></h1>
    ...
    '[[*pagetitle]]' => 'Learning',
    '[[$categoryPage]]' => '[[!getResources? &parents=`2` &tpl=`postTeaserTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`category==%Learning%` ]]',
