...
&sortOrder=`DESC`
      ...
      <nav class="top-bar small branding show-for-small" data-topbar>
        <ul class="title-area">
          <li class="name">
            <h1><a href="#">octave <span class="branding-research">research</span></a></h1>
          </li>
...
<div><a href="index.php?id=95" id="blog_title"><h3>Community Builders</h3></a>
<div id="frontpage_story_meta">by Timothy Voice, on 12/04 - filed under Hospitality</div>
</div>
<br class="clear" />
<div id="report_download"></div>
<div class="report_intro"><p>All restaurants rely on some form of community to survive. But some take on a central role, becoming a lynchpin for community building. They generate community buy-in, propagate a lifestyle through classes, events and publications, and generally make community engagement central to their success.</p></div>
<div id="main_story">
<h3>Roberta\'s</h3>
...
<div class="random_post_container twelve columns alpha omega">
[[!getResources? 
&parents=`2` 
&limit=`3`
&hideContainers=`1`
&sortby=`RAND()`
&resources=`-95`
&tpl=`researchPostRandomTpl`
&tplLast=`researchPostRandomLastTpl`
&tplFirst=`researchPostRandomFirstTpl`  
&includeContent=`1` 
&showHidden=`1` 
&includeTVs=`1` 
&processTVs=`1` 
&tvPrefix=``]]
</div><!--random_post_container-->
[[$menu]]
</div><!--end container-->
...
<div class="report_intro"><p>[[*introtext]]</p></div>
